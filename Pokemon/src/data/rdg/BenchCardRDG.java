...
public class BenchCardRDG {
	...
	public BenchCardRDG(int id, int deckId, int sequenceId, int cardtypeId) {
		this.id = id;
		this.deckId = deckId;
		this.sequenceId = sequenceId;
		this.cardtypeId = cardtypeId;
	...
	public int insert() throws SQLException {
		String sql = "INSERT INTO BENCHCARD (id, deckId, sequenceId, cardtypeId) VALUES (?, ?, ?, ?);";
	...
	public int delete() throws SQLException {
		String sql = "DELETE FROM BENCHCARD WHERE deckId = '" + this.deckId + "' AND sequenceId = '" + this.sequenceId + "';";
		Connection con = DbConnectionManager.getConnection();
		PreparedStatement ps = con.prepareStatement(sql);
		int res = ps.executeUpdate();
		ps.close();
	...
	public int deleteAll() throws SQLException {
		String sql = "DELETE FROM BENCHCARD WHERE id = '" + this.id  + "';";
		Connection con = DbConnectionManager.getConnection();
		PreparedStatement ps = con.prepareStatement(sql);
		int res = ps.executeUpdate();
		ps.close();
	...
	public static int BenchSize(int id) throws SQLException {
		String sql = "SELECT COUNT(" + id + ") AS count FROM BENCHCARD WHERE id = '" + id + "';";
	...
	public static List<HandCardRDG> viewBench(int id) throws SQLException{
		ArrayList<HandCardRDG> list = new ArrayList<>();
		String sql = "SELECT * FROM BENCHCARD WHERE id = '" + id + "';";
